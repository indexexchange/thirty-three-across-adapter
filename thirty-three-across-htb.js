...
var PartnerSpecificValidator = require('thirty-three-across-htb-validator.js');
 ...
 * @class
 */
function ThirtyThreeAcrossHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'ThirtyThreeAcrossHtb', // PartnerName
            namespace: 'ThirtyThreeAcrossHtb', // Should be same as partnerName
            statsId: 'TTAC', // Unique partner identifier
            version: '2.1.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
...
module.exports = ThirtyThreeAcrossHtb;